...
function admin_list(responseText){
	if(responseText==-1){
...
function get_admin(){
	var req_url="./admin_get.php?id="+get_query_string("id")+"&pw="+get_query_string("pw")+"&page="+page;
	var xmlhttp;
	...
	xmlhttp.onreadystatechange=function() {
		if (xmlhttp.readyState==4 && xmlhttp.status==200){
			admin_list(xmlhttp.responseText)
		}
	};
...
if(page==0){
	...
	document.getElementById("former-page").href="./admin_list.html?id="+get_query_string("id")+"&pw="+get_query_string("pw")+"&page="+page;
}
else{
	document.getElementById("former-page").style.visibility="visible";
	var temp_page=page-1;
	document.getElementById("former-page").href="./admin_list.html?id="+get_query_string("id")+"&pw="+get_query_string("pw")+"&page="+temp_page;
}

var temp_page=parseInt(page)+1;
document.getElementById("next-page").href="./admin_list.html?id="+get_query_string("id")+"&pw="+get_query_string("pw")+"&page="+temp_page;

...
QT_MOC_LITERAL(1, 7, 8), // "send_msg"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 3) // "msg"

    },
    "Member\0send_msg\0\0msg"
};
...
void Member::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Member *_t = static_cast<Member *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_msg((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Member::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Member::send_msg)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Member::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Member.data,
      qt_meta_data_Member,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Member::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Member.stringdata0))
        return static_cast<void*>(const_cast< Member*>(this));
...
// SIGNAL 0
void Member::send_msg(QString _t1)
{
